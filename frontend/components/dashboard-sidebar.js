  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center h-16 px-4 border-b">
          ...
          <SheetContent side="left" className="w-[240px] sm:w-[300px]">
            <div className="flex flex-col h-full py-4">
              <div className="px-3 py-2">
                <h2 className="mb-2 px-4 text-lg font-semibold">Patient Dashboard</h2>
              </div>
        ...
        <div className="ml-2 text-lg font-semibold">Patient Dashboard</div>
      </div>

      {/* Desktop Sidebar */}
      <div className="hidden md:flex md:w-[240px] md:flex-col md:fixed md:inset-y-0 md:left-0 z-10">
        <div className="flex flex-col h-full py-4 border-r bg-muted">
          <div className="px-3 py-2">
            <h2 className="mb-2 px-4 text-lg font-semibold">Patient Dashboard</h2>
          </div>
          <div className="flex-1">
